...
<aside class="app-sidebar">
    ...
    <ul class="app-menu text-capitalize">
        ...
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/list_paiements');?>"><i class="app-menu__icon fa fa-money fa-lg text-primary"></i><span class="app-menu__label">Lister paiements</span></a></li>
    </ul>
</aside>
