...
<aside class="app-sidebar">
    ...
    <ul class="app-menu text-capitalize">
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/vue_lancer_annee');?>"><i class="app-menu__icon fa fa-calendar text-primary"></i><span class="app-menu__label">Lancer année</span></a></li>
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/vue_ajout_et');?>"><i class="app-menu__icon fa fa-plus text-primary"></i><span class="app-menu__label">Ajouter étudiant</span></a></li>
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/vue_list_et');?>"><i class="app-menu__icon fa fa-list fa-lg text-primary"></i><span class="app-menu__label">Lister étudiants</span></a></li>
    </ul>
</aside>
