    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="tile">
                ...
                <div class="tile-body text-justify">
                    Entant qu'étudiant de l'Iss, vous avez comme mission principale la consultation de vos paiements déjà effectués.
                    Vos privilèges, vous permettent d'afficher une liste de tous les différents frais que vous avez déjà payés pour le compte de l'Iss.
