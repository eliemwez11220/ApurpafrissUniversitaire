...
<aside class="app-sidebar">
    ...
    <ul class="app-menu text-capitalize">
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/paiements_et');?>"><i class="app-menu__icon fa fa-eye fa-lg text-primary"></i><span class="app-menu__label">Consulter paiements</span></a></li>
    </ul>
</aside>
