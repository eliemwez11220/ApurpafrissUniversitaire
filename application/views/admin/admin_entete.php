            ...
            <ul class="app-notification dropdown-menu dropdown-menu-right">
                ...
                <div class="app-notification__content">
                    <li><a class="app-notification__item" href="javascript:;"><span class="app-notification__icon"><span class="fa-stack fa-lg"><i class="fa fa-circle fa-stack-2x text-primary"></i><i class="fa fa-envelope fa-stack-1x fa-inverse"></i></span></span>
                            <div>
                                <p class="app-notification__message">Un message sur la gestion des utilisateurs</p>
...
<aside class="app-sidebar">
    ...
    <ul class="app-menu text-capitalize">
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/vue_ajout_ut');?>"><i class="app-menu__icon fa fa-user-plus text-primary"></i><span class="app-menu__label">Ajouter Utilisateur</span></a></li>
        <li><a class="app-menu__item" href="<?= base_url($this->session->role_ut . '/vue_list_ut');?>"><i class="app-menu__icon fa fa-users fa-lg text-primary"></i><span class="app-menu__label">Lister Utilisateurs</span></a></li>
    </ul>
</aside>
